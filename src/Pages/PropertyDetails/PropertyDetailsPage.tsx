      ...
      <main className="flex-1 pt-32 pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-12 animate-fade-in">
            <div className="lg:col-span-2 h-[500px] overflow-hidden rounded-xl">
              <Image
                src={property.image}
                alt={property.title}
                width={800}
            ...
            {property.images?.slice(1).map((image, index) => (
              <div key={index} className="h-64 overflow-hidden rounded-xl">
                <Image
                  src={image}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              {/* Agent Card */}
              <Card className="card-shadow sticky top-32">
